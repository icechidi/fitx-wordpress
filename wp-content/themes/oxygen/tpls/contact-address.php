...
$address_title = oxygen_get_field( 'address_title' );
$address       = oxygen_get_field( 'address' );

$route_finder = oxygen_get_field( 'enable_route_finder' );

$location_disabled = ! apply_filters( 'oxygen_disable_contact_map_current_location', false );

if ( $location_disabled && 'hide' !== $route_finder ) {
	$route_finder = 'address';
}
?>
<!-- Address Block -->
<div class="row">
                    ...
                    <div class="route-options-container">
						...
						<?php if ( $route_finder == 'both' || $route_finder == 'location' ) : ?>
                            <div class="route-options">
                                <input type="radio" name="location" value="gps" id="gps-type"/>
                            ...
                            <div class="route-options">
                                ...
                                <div class="address-field<?php echo $route_finder == 'address' ? ' visible' : ''; ?>">
                                    <input type="text" class="form-control"
                                           placeholder="<?php _e( 'Enter your address...', 'oxygen' ); ?>"/>
                                    <span class="error"><?php _e( 'Cannot find this address!', 'oxygen' ); ?></span>
                                </div>
                            </div>
						<?php endif; ?>

                        <button type="button" class="btn btn-default to-uppercase" id="calc-route" data-key="<?php echo esc_attr( oxygen_google_api_key() ); ?>"><?php _e( 'Calculate route', 'oxygen' ); ?></button>
...
<?php if ( $route_finder ) : ?>
    <script type="text/javascript">
		...
		contact_vars.carPin = '<?php echo oxygen_get_theme_assets_uri(); ?>/images/pin-car.png';
    </script>
<?php endif; ?>
