...
$url_to_script = get_template_directory_uri() . "/inc/lib/visual-composer/param-types/listrows/listrows_param_type.js";

vc_add_shortcode_param( 'listrows', 'list_rows_wpb_param_type', $url_to_script );
