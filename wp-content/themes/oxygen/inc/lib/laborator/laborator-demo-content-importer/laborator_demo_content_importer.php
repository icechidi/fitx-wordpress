...
function lab_1cl_demo_installer_get_packs() {
	return array(
		array(
			...
			// Pack Data
			'thumb'      => 'demo-content/main-demo/screenshot.jpg',
			'file'       => 'demo-content/main-demo/content.xml',
			'options'    => 'demo-content/main-demo/options.json',
			'revslider'  => array(
				'demo-content/main-demo/revslider-sample.zip',
				'demo-content/main-demo/revslider-homepage.zip',
				//'demo-content/main-demo/revslider-christmas-snow-scene.zip',
			),
			'custom_css' => '',
			...
			'url' => 'https://demo.oxygentheme.com/?header_type=2',
		),
		...
		array(
			...
			// Pack Data
			'thumb'      => 'demo-content/minimal-demo/screenshot.jpg',
			'file'       => 'demo-content/minimal-demo/content.xml',
			'options'    => 'demo-content/minimal-demo/options.json',
			'revslider'  => 'demo-content/minimal-demo/revslider-homepage.zip',
			...
			'url' => 'https://demo.oxygentheme.com/minimal/?header_type=3'
		),
	);
}
...
function lab_1cl_demo_installer_pack_content_types( $pack ) {
	...
	if ( isset( $pack[ 'revslider' ] ) && $pack[ 'revslider' ] ) {
		...
		$content_packs[] = array(
			...
			'requires'    => array(
				'revslider' => 'To import Slider Revolution content you must install and activate this plugin in <a href="' . esc_url( admin_url( "themes.php?page=tgmpa-install-plugins" ) ) . '" target="_blank">Appearance &raquo; Install Plugins</a> and then refresh this page.'
			),
			...
			try {
				...
				if ( $pack[ 'revslider' ] && class_exists( 'RevSlider' ) ) {
					...
					foreach ( $pack[ 'revslider' ] as $revslider_path ) {
						...
						$revslider = dirname( __FILE__ ) . DIRECTORY_SEPARATOR . $revslider_path;
					...
					$resp[ 'errorMsg' ] = 'Slider Revolution is not installed/activated and thus this content source couldn\'t be imported!';
				}
			} catch ( Exception $e ) {
				$resp[ 'errorMsg' ] = $e;
			}
